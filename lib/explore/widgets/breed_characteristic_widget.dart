...
class BreedCharacteristicWidget extends StatelessWidget {
  ...
  const BreedCharacteristicWidget({this.petDetailsProvider});
              ...
              ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return _buildCharacteristicCard(
                      petDetailsProvider.pet.breedCharacteristics[index],
                      context);
                },
                itemCount: petDetailsProvider.pet.breedCharacteristics.length,
              ),
            ],
          ),
        ),
  ...
  Widget _buildCharacteristicCard(
    ...
    breedCharacteristic.survey.forEach((key, petDetailsProvider) {
      surveyKeys.add(key);
      surveyDogDetailsProviders.add(petDetailsProvider);
    });
    return Container(
      padding: const EdgeInsets.all(8),
      decoration: BoxDecoration(
